...
namespace Exercise
{
    class Program
    {
        ...
        */
        public static int[] game = new int[] { 60, 24, 20, 12, 6, 4, 2 };
        ...
        */
        {
            ...
            if (rolledAnimals[0] == 7 || rolledAnimals[1] == 8) // Jeżeli wylosujemy wilka lub lisa...
            {
                if (rolledAnimals[0] == 7)
                {
                    ...
                    else
                    {
                        ...
                        GameResources(1, player[1], 0);
                        GameResources(2, player[2], 0);
                        GameResources(3, player[3], 0);
                        player[1] = 0;
                        player[2] = 0;
                        player[3] = 0;
                    }
            ...
            else // Każdy inny przypadek
            {
                    ...
                    {
                        tempNumber1 = player[rolledAnimals[0]] + 2;
                        tempNumber1 /= 2;
                        if (GameResources(rolledAnimals[0], tempNumber1, 1))
                        {
                            player[rolledAnimals[0]] += tempNumber1;
                        }
                        else
                        {
                            GameResources(rolledAnimals[0], game[rolledAnimals[0]], 1);
                            Console.WriteLine("");
                            Console.WriteLine("UWAGA");
                            Console.WriteLine("");
                            Console.WriteLine("Gra nie posiada już dostępnych kartoników z zwierzęciem {0}.", AnimalName(0));
                            Console.WriteLine("Gra przekazała wszystkie kartoniki dostępne w pudełku.");
                            Console.WriteLine("");
                            Console.WriteLine("");
                        }
                    }
                    ...
                    {
                        tempNumber1 = player[rolledAnimals[0]] + 1;
                        tempNumber2 = player[rolledAnimals[1]] + 1;
                        tempNumber1 /= 2;
                        if (GameResources(rolledAnimals[0], tempNumber1, 1))
                        {
                            player[rolledAnimals[0]] += tempNumber1;
                        ...
                        tempNumber2 /= 2;
                        if (GameResources(rolledAnimals[1], tempNumber2, 1))
                        {
                            player[rolledAnimals[1]] += tempNumber2;
                        }
                        else
                        {
                            GameResources(rolledAnimals[1], game[rolledAnimals[1]], 1);
                            Console.WriteLine("");
                            Console.WriteLine("UWAGA");
                            Console.WriteLine("");
                            Console.WriteLine("Gra nie posiada już dostępnych kartoników z zwierzęciem {0}.", AnimalName(0));
        ...
        */
        {
            ...
            switch (animalType)
            {
                case 1:
                    ...
                    {
                        if (GameResources(1, animalAmount, 1))
                        {
                            player[0] -= 6 * animalAmount;
                            GameResources(0, 6*animalAmount, 0);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("UWAGA");
                            Console.WriteLine("");
                            Console.WriteLine("Gra nie posiada wystarczającej liczby kartoników do przeprowadzenia");
                            Console.WriteLine("wymiany. Wymiana została odrzucona.");
                            Console.WriteLine("Liczba pozostałych zwierząt typu {0} to {1}", AnimalName(1), game[1]);
                            TradeSuccess = false;
                        }
                    }
                break;
                ...
                case 2:
                    ...
                    {
                        if (GameResources(2, animalAmount, 1))
                        {
                            player[1] -= 2 * animalAmount;
                            GameResources(1, 2 * animalAmount, 0);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Gra nie posiada wystarczającej liczby kartoników do przeprowadzenia");
                            Console.WriteLine("wymiany. Wymiana została odrzucona.");
                            Console.WriteLine("Liczba pozostałych zwierząt typu {0} to {1}", AnimalName(2), game[2]);
                            TradeSuccess = false;
                        }
                    }
                break;
                ...
                case 3:
                    ...
                    {
                        if (GameResources(3, animalAmount, 1))
                        {
                            player[2] -= 3 * animalAmount;
                            GameResources(2, 3 * animalAmount, 0);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Gra nie posiada wystarczającej liczby kartoników do przeprowadzenia");
                            Console.WriteLine("wymiany. Wymiana została odrzucona.");
                            Console.WriteLine("Liczba pozostałych zwierząt typu {0} to {1}", AnimalName(3), game[3]);
                            TradeSuccess = false;
                        }
                    }
                break;
                ...
                case 4:
                    ...
                    {
                        if (GameResources(4, animalAmount, 1))
                        {
                            player[3] -= 2 * animalAmount;
                            GameResources(3, 2 * animalAmount, 0);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Gra nie posiada wystarczającej liczby kartoników do przeprowadzenia");
                            Console.WriteLine("wymiany. Wymiana została odrzucona.");
                            Console.WriteLine("Liczba pozostałych zwierząt typu {0} to {1}", AnimalName(4), game[4]);
                            TradeSuccess = false;
                        }
                    }
                break;
                ...
                case 5:
                    ...
                    {
                        if (GameResources(5, animalAmount, 1))
                        {
                            player[1] -= 1 * animalAmount;
                            GameResources(1, 1 * animalAmount, 0);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Gra nie posiada wystarczającej liczby kartoników do przeprowadzenia");
                            Console.WriteLine("wymiany. Wymiana została odrzucona.");
                            Console.WriteLine("Liczba pozostałych zwierząt typu {0} to {1}", AnimalName(5), game[5]);
                            TradeSuccess = false;
                        }
                    }
                break;
                ...
                case 6:
                    ...
                    {
                        if (GameResources(6, animalAmount, 1))
                        {
                            player[3] -= 1 * animalAmount;
                            GameResources(3, 1 * animalAmount, 0);
                        ...
                        else
                        {
                            ...
                            Console.WriteLine("Gra nie posiada wystarczającej liczby kartoników do przeprowadzenia");
                            Console.WriteLine("wymiany. Wymiana została odrzucona.");
                            Console.WriteLine("Liczba pozostałych zwierząt typu {0} to {1}", AnimalName(6), game[6]);
                            TradeSuccess = false;
                        }
                    }
                break;
        ...
        public static bool GameResources(int animalType, int animalAmount, int operation)
        /*
            Funkcja obsługuje ilość kartoników w grze. 
            Zwraca boola true/false. True jeżeli operacja była możliwa do wykonania i false jeżeli nie. 
            operation to int 0 lub 1. Jeżeli 0, operacja to dodawanie, jeżeli 1 to odejmowanie.
        */
        {
            switch (operation)
            {
                case 0:
                    game[animalType] += animalAmount;
                break;

                case 1:
                    if (game[animalType] - animalAmount >= 0)
                    {
                        game[animalType] -= animalAmount;
                        return true;
                    }
        ...
        public static void Main(string[] args)
        {
            ...
            while (true) // Pętla z grą
            {
                for (int i = 0; i < players; i++)
                {
                    ...
                    Console.WriteLine("GRA POSIADA: {0} KRÓLIKÓW", game[0]);
